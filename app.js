...
const views = {
  landing: {
    ...
    screen: () => el('div', { class: 'screen' },
      ...
      el('h1', { class: 'title-xl', style: 'margin-top:14px' }, 'HOT'),
      ...
      el('div', { style: 'display:flex;justify-content:space-between;align-items:center;' },
        el('div', { style: 'font-size:32px;letter-spacing:2px' }, '🔥💩'),
        el('div', { class: 'mono', style: 'font-size:11px;font-weight:700;color:var(--accent)' }, '◉ PRESS ▶ 02'),
      ),
    ),
    keys: () => [
